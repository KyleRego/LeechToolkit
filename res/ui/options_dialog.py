...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        # OptionsDialog.setWindowModality(QtCore.Qt.WindowModality.WindowModal) # 修正
...
"\n"
"Version: {version}  \n"
"Have any issues, feedback,or questions? Feel free to post on the project\'s issue section on [GitHub](https://github.com/iamjustkoi/LeechToolkit/issues)!  \n"
"\n"
