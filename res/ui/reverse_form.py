...
class Ui_ReverseForm(object):
    def setupUi(self, ReverseForm:QtWidgets.QWidget):
        ...
        # call: setSizePolicy(self, a0: QSizePolicy): argument 1 has unexpected type 'QSizePolicy'
        # setSizePolicy(self, hor: QSizePolicy.Policy,
        # ver: QSizePolicy.Policy): argument 1 has unexpected type 'QSizePolicy'
